...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/coolbeans')
    .then(res => {
    console.log(res.data)

    let repeatTextEl = document.getElementById('repeat-text');
    repeatTextElement.textContent = res.data;
    
    repeatTextElement.style.display = 'block';
...
axios.get('http://localhost:3000/query-test?car-blue=cool-car-blue')
